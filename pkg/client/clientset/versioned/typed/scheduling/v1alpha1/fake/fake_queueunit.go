...
var queueunitsResource = v1alpha1.SchemeGroupVersion.WithResource("queueunits")

var queueunitsKind = v1alpha1.SchemeGroupVersion.WithKind("QueueUnit")
...
func (c *FakeQueueUnits) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(queueunitsResource, c.ns, name, opts), &v1alpha1.QueueUnit{})
