...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1alpha1.SchemeGroupVersion.WithResource("podgroups"):
		...
		// Group=scheduling.sigs.k8s.io, Version=v1beta1
	case v1beta1.SchemeGroupVersion.WithResource("elasticquotatrees"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Scheduling().V1beta1().ElasticQuotaTrees().Informer()}, nil
