...
type SchedulingV1beta1Interface interface {
	...
	ElasticQuotaTreesGetter
}

// SchedulingV1beta1Client is used to interact with features provided by the scheduling.sigs.k8s.io group.
type SchedulingV1beta1Client struct {
	restClient rest.Interface
}

func (c *SchedulingV1beta1Client) ElasticQuotaTrees(namespace string) ElasticQuotaTreeInterface {
	return newElasticQuotaTrees(c, namespace)
}
