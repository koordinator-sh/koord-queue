...
type ElasticQuotaApplyConfiguration struct {
	...
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	Summary                          *QueueUnitsSummaryApplyConfiguration `json:"QueueUnitsSummary,omitempty"`
}

// ElasticQuota constructs a declarative configuration of the ElasticQuota type for use with
// apply.
func ElasticQuota(name string) *ElasticQuotaApplyConfiguration {
...
func (b *ElasticQuotaApplyConfiguration) WithSummary(value *QueueUnitsSummaryApplyConfiguration) *ElasticQuotaApplyConfiguration {
	b.Summary = value
	return b
}
