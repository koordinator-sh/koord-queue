	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.VisibilityV1alpha1().Queues().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.VisibilityV1alpha1().Queues().Watch(context.TODO(), options)
			},
		},
		&apisv1alpha1.Queue{},
		resyncPeriod,
...
func (f *queueInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisv1alpha1.Queue{}, f.defaultInformer)
}
