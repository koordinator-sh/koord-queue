...
import (
	...
	v1alpha1 "github.com/koordinator-sh/koord-queue/pkg/visibility/apis/client-go/listers/apis/v1alpha1"
	apisv1alpha1 "github.com/koordinator-sh/koord-queue/pkg/visibility/apis/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.VisibilityV1alpha1().ElasticQuotas().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.VisibilityV1alpha1().ElasticQuotas().Watch(context.TODO(), options)
			},
		},
		&apisv1alpha1.ElasticQuota{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *elasticQuotaInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisv1alpha1.ElasticQuota{}, f.defaultInformer)
}
